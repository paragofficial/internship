          ...
          <div style={{ margin: '10px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '10px' }}>
            <ul style={{ listStyleType: 'none', margin: 0, padding: 0 }}>
              <li style={{ margin: '20px', padding: '20px' }}>
                <a
                  href='https://www.amazon.in/s?k=seasonal+gift+kits&crid=64YOB5YAOK2P&sprefix=seasonal+gift+kits%2Caps%2C238&ref=nb_sb_noss'
                  target='_blank'
              ...
              <li style={{ margin: '20px', padding: '20px' }}>
                <a
                  href='https://www.amazon.in/s?k=small+gesture&crid=1DW3KGQ983NGR&sprefix=small+gesture%2Caps%2C201&ref=nb_sb_noss_2'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ color: 'white', fontSize: 20, textDecoration: 'none' }}
                >
              ...
              <li style={{ margin: '20px', padding: '20px' }}>
                <a
                  href='https://www.amazon.in/s?k=gift+for+self+care&crid=136OKEVGLXEX5&sprefix=gift+for+self+care%2Caps%2C216&ref=nb_sb_noss_2'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ color: 'white', fontSize: 20, textDecoration: 'none' }}
                >
              ...
              <li style={{ margin: '20px', padding: '20px' }}>
                <a
                  href='https://www.amazon.in/s?k=gift+for+travels&crid=2SVMHL1ESAS0&sprefix=gift+for+travel%2Caps%2C205&ref=nb_sb_noss_1'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ color: 'white', fontSize: 20, textDecoration: 'none' }}
                >
              ...
              <li style={{ margin: '20px', padding: '20px' }}>
                <a
                  href='https://www.amazon.in/s?k=gift+bundles&crid=22CQH4KCSSZKG&sprefix=gift+bundle%2Caps%2C209&ref=nb_sb_noss_1'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ color: 'white', fontSize: 20, textDecoration: 'none' }}
                >
